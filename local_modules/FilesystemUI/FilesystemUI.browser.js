...
class FilesytemUI extends FilesystemUI_Abstract {
  ...
  async PresentDialogToSaveBase64ImageStringAsImageFile (
    ...
    const self = this
      ...
      // 2020-12-15 12:53:06.975 10787-10787/com.mysafex.android V/Capacitor/Filesystem: Permission 'android.permission.WRITE_EXTERNAL_STORAGE' is granted
      // 2020-12-15 12:53:06.978 10787-10787/com.mysafex.android E/Capacitor/Filesystem: Not able to create 'DOCUMENTS'!
      // 2020-12-15 12:53:06.978 10787-10787/com.mysafex.android D/Capacitor: Sending plugin error: {"save":false,"callbackId":"36944607","pluginId":"Filesystem","methodName":"writeFile","success":false,"error":{"message":"NOT_CREATED_DIR"}}
      console.log('Running native capacitor -- attempt to write file')
			let filename = 'MySafex-Payment-Request-' + Date.now() + '.png'
