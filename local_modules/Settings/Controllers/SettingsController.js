...
const k_defaults_record =
{
  ...
  invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount: false,
...
class SettingsController extends EventEmitter {
  ...
  _tryToBoot () {	// we can afford to do this w/o any callback saying "success" because we defer execution of
    ...
    function _proceedTo_loadStateFromRecord (record_doc) {
      ...
      self.invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount = record_doc.invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount
      ...
      function () {
        ...
        for (const valueKey of valueKeys) {
          ...
          { // validate / mark as updated for yield later
            ...
            // NOTE: not checking invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount b/c invisible_ and therefore always set programmatically
          }
          { // set
            self[valueKey] = value
          }
        ...
        const persistableDocument =
				{
				  ...
				  invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount: self.invisible_hasAgreedToTermsOfCalculatedEffectiveSafexAmount,
