...
class FundsRequestDetailsView extends View {
  ...
  new_requesteeMessagePlaintextString () {
    ...
    {
      value += 'Someone has requested a Safex payment'
    ...
    value += '\r\n' // spacer
    value += '\r\n---------------------------'
    value += `\r\nIf you have MySafex installed, use this link to send the funds: ${self.fundsRequest.Lazy_URI__addressAsAuthority()}`
    value += '\r\n'
    value += `\r\nIf you don't have MySafex installed, download it from ${'https://' + self.context.appDownloadLink_domainAndPath}`
    //
    return value
  }
  ...
  new_requesteeMessageHTMLString () {
    ...
    value += '<p>---------------------------</p>'
    value += `<p>If you have MySafex installed, <a href="${self.fundsRequest.Lazy_URI__addressAsAuthority()}">press this link to send the funds</a>.</p>`
    const appDownloadLink_domainAndPath = self.context.appDownloadLink_domainAndPath
    value += `<p>If you don't have MySafex installed, download it from <a href="https://${appDownloadLink_domainAndPath}">${appDownloadLink_domainAndPath}</a>.</p>`
    //
    return value
  }
